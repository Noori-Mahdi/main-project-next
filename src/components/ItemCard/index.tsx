  ...
  return (
    <div className="w-52 h-72 rounded-md bg-slate-600 border-2  hover:border-yellow-800">
      <div className="h-2/3 w-full bg-neutral-700 overflow-hidden  rounded-tr-md rounded-tl-md relative">
        ...
        <div className='absolute flex justify-center left-0 top-0 -translate-x-1/4 translate-y-1/2 -rotate-45 w-6/12 bg-yellow-800 font-semibold text-gray-300'>10 %</div>
        <Image alt='product1'  src={'/public/uploads/userImage/user2.jpeg'} width={30} height={30}/>
      </div>
      <div className="h-1/3 p-2 w-full flex flex-col justify-between">
      <div className=' capitalize text-sm font-semibold tracking-wide'>title </div>
       <div className='flex justify-between gap-1 items-center'>
        <div className='flex gap-1'>
        <DynamicIcon className='text-sm text-yellow-500' iconName='faStar'/>
        <div className='text-sm font-medium'>3/5</div>
        </div>
        <div className='text-base flex items-end gap-2 font-semibold'>
            <div className='line-through text-sm text-gray-300'>9.99 $</div>
            <div className=''>8.99 $</div>
        </div>
